	...
	return (
		<div className="grid content-between group">
			...
			<div className="grid">
				...
				<div className="z-10 dark:bg-theme-dark-background-light bg-theme-light-background-dark text-theme-black dark:text-theme-white px-[4%] py-[2%] rounded-md col-start-1 row-start-1 justify-self-end self-end min-w-max">
